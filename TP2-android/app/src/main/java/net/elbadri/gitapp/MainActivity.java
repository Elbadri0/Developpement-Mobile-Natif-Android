...
import net.elbadri.gitapp.R;
import net.elbadri.gitapp.model.GitUser;
import net.elbadri.gitapp.model.GitUsersResponse;
import net.elbadri.gitapp.model.UsersListViewModel;
import net.elbadri.gitapp.service.GitRepoServiceAPI;
